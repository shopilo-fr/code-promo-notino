 ...
 * Homepage: https://shopilo.fr/reductions/notino.fr
 */

const SHOPILO_URL = "https://shopilo.fr/reductions/notino.fr";
const STORE_NAME  = "Notino";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-fr/code-promo-notino)" }
  });
