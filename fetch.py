#!/usr/bin/env python3
"""
Recuperation des codes promo Notino depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/notino.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/notino.fr"
STORE_NAME = "Notino"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Notino depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-notino)"
    }
    try:
